...
import "./RgrDashboardDatatable.css";
...
const RgrDashboardDatatable = (props) => {
  const {
    title,
    data,
    column,
...
export default RgrDashboardDatatable;
  ...
  return (
    <>
      <div>
        ...
        {createRgrBtn && (
          <div className="ftBtn createInvceBtn" onClick={handleCreateRgr}>
            <button>Create RGR</button>
          </div>
        )}
