...
import RgrHeaderComponent from './RgrHeaderComponent';
...
const RgrHeaderContainer = (props) => {
  ...
  return (<>
    <RgrHeaderComponent logout={logout} vendorCode={usersData && usersData.VendorCode} name={usersData && usersData.FullName}/>
    <ToastContainer />
    </> )
}

export default RgrHeaderContainer