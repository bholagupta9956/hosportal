...
const SupplierInvoiceListDataTable = (props) => {
  const { title, data, column, getList, showNextBtn, isLoading , saveList , submitList , status } = props;
...
export default SupplierInvoiceListDataTable;
