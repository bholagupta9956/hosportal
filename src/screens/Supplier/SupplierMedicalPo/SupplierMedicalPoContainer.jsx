...
import SupplierMedicalPoComponent from "./SupplierMedicalPoComponent";
...
const SupplierMedicalPoContainer = () => {
  ...
  const MedicalPoList = (index , Text = searchText) => {
    ...
    const val = {
      ...
      SearchText: Text,
      POType:
        "'Z101','Z103','Z104','Z105','Z106','Z107','Z108','Z109','Z111','Z113','ZLEG'",
      IsActive: true,
    };
    setLoading(true);
    axios
  ...
  return (
    <>
      <SupplierMedicalPoComponent
        data={data}
        column={column}
        getList={MedicalPoList}
        totalData={totalData}
        isLoading={loading}
...
export default SupplierMedicalPoContainer;
